...
# from employees.views import index, show_employees, update_employee, EmployeeCreateView, EmployeeDeleteView
...
urlpatterns = ([
    ...
    # path('<int:pk>/update/', update_employee, name='employee_update'),
